...
from commformer.envs.football.football_env import FootballEnv
from commformer.runner.shared.football_runner import FootballRunner as Runner
...
def main(args):
    ...
    elif all_args.algorithm_name == "commformer" or all_args.algorithm_name == "commformer_dec":
